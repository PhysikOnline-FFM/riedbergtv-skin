...
_V_.HDToggleButton = _V_.Component.extend({
    /* --- initialization --------------------------------------------------- */
    
    init: function(player, options){
        console.log("HDToggleButton implementation works!?!?");
        this.sdURL = null;
        this.hdURL = "test";
        this.isUsingSD = true;
    ...
    onHDButtonClick: function(event, button) {
        ...
        if (this.isUsingSD) {
            ...
            //console.log("sdURL:"+this.sdURL);
            var strs = this.sdURL.split('.');
            var ext = strs.pop();
            //console.log("var ext:"+ext);
            strs.pop();
            //console.log("var strs:"+strs);
            var fname = strs.join('.')+"."+ext;
